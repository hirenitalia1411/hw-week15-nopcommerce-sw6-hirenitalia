...
public class RegistrationSteps {
    ...
    public void iEnterPasswordForRegistration(String pass) {
        new RegisterPage().sendDataToPasswordField(pass);
    }

    @And("I enter confirm password for registration {string}")
    public void iEnterConfirmPasswordForRegistration(String cPass) {
        new RegisterPage().sendDataToConfirmPasswordField(cPass);
    }
